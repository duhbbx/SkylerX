...
.bar-name { font-family: var(--font-mono); color: var(--muted); text-align: right; }
.bar-fill { background: rgba(124, 108, 255, 0.4); padding: 2px 8px; color: #fff; border-radius: 3px; font-family: var(--font-mono); min-width: 50px; }
