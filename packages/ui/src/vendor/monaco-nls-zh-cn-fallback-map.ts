 ...
 */
/* AUTO-GENERATED. Maps Monaco built-in localize() fallback strings to zh-cn translations,
 * derived by joining min/editor.main.js (localize(idx,fallback)) with dev/.../nls.messages.zh-cn.js by idx.
 */
export const ZH_CN_FALLBACK_MAP: Record<string, string> = {
  '(empty)': '(空)',
  '{0}: {1}': '{0}: {1}',
  'A system error occurred ({0})': '发生了系统错误 ({0})',
  'An unknown error occurred. Please consult the log for more details.':
    '出现未知错误。有关详细信息，请参阅日志。',
  '{0} ({1} errors in total)': '{0} 个(共 {1} 个错误)',
  Ctrl: 'Ctrl',
  Shift: 'Shift',
  Alt: 'Alt',
  Windows: 'Windows',
  ...
  'Warning: {0}': '警告: {0}',
  'Info: {0}': '信息: {0}',
  ' or {0} for history': ' 或使用 {0} 以查看历史记录',
  ' ({0} for history)': ' (使用 {0} 查看历史记录)',
  'Cleared Input': '清除的输入',
  input: '输入',
  'Preserve Case': '保留大小写',
  'More Actions...': '更多操作...',
  ...
  'Optimize for usage with a Screen Reader.': '针对屏幕阅读器的使用进行优化。',
  'Assume a screen reader is not attached.': '假定未连接屏幕阅读器。',
  ...
  'Show Peek view of the results (default)': '显示结果的速览视图(默认)',
  'Go to the primary result and show a Peek view': '转到主结果并显示速览视图',
  ...
  "Prefer showing hovers above the line, if there's space.": '如果有空间，首选在线条上方显示悬停。',
  ...
  'Disable the code action menu.': '禁用代码操作菜单。',
  ...
  'Enables the Code Action lightbulb in the editor.': '在编辑器中启用代码操作小灯泡提示。',
  'Shows the nested current scopes during the scroll at the top of the editor.':
    '在编辑器顶部的滚动过程中显示嵌套的当前作用域。',
  'Defines the maximum number of sticky lines to show.': '定义要显示的最大粘滞行数。',
  ...
  "Enable scrolling of Sticky Scroll with the editor's horizontal scrollbar.":
    '使用编辑器的水平滚动条启用粘滞滚动。',
  'Enables the inlay hints in the editor.': '在编辑器中启用内联提示。',
  'Inlay hints are enabled': '已启用内嵌提示',
  ...
  'Inlay hints are disabled': '已禁用内嵌提示',
  ...
  'Enables the padding around the inlay hints in the editor.': '在编辑器中启用叠加提示周围的填充。',
  'Controls whether the minimap is shown.': '控制是否显示缩略图。',
  'Controls whether the minimap is hidden automatically.': '控制是否自动隐藏缩略图。',
  ...
  'Controls the size of the minimap.': '控制迷你地图的大小。',
  'Controls the side where to render the minimap.': '控制在哪一侧显示缩略图。',
  'Controls when the minimap slider is shown.': '控制何时显示迷你地图滑块。',
  'Scale of content drawn in the minimap: 1, 2 or 3.': '在迷你地图中绘制的内容比例: 1、2 或 3。',
  ...
  'Controls the font size of section headers in the minimap.': '控制缩略图中节标题的字号。',
  ...
  'Quick suggestions show inside the suggest widget': '快速建议显示在建议小组件内',
  'Quick suggestions show as ghost text': '快速建议显示为虚影文本',
  'Quick suggestions are disabled': '已禁用快速建议',
  'Enable quick suggestions inside strings.': '在字符串内启用快速建议。',
  'Enable quick suggestions inside comments.': '在注释内启用快速建议。',
  'Enable quick suggestions outside of strings and comments.': '在字符串和注释外启用快速建议。',
  ...
  'Line numbers are not rendered.': '不显示行号。',
  'Line numbers are rendered as absolute number.': '将行号显示为绝对行数。',
  'Line numbers are rendered as distance in lines to cursor position.':
    '将行号显示为与光标相隔的行数。',
  'Line numbers are rendered every 10 lines.': '每 10 行显示一次行号。',
  'Controls the display of line numbers.': '控制行号的显示。',
  'Number of monospace characters at which this editor ruler will render.':
    '此编辑器标尺将渲染的等宽字符数。',
  'Color of this editor ruler.': '此编辑器标尺的颜色。',
  ...
  'Defines allowed characters that are not being highlighted.': '定义未突出显示的允许字符。',
  ...
  'Never show the inline suggestion toolbar.': '从不显示内联建议工具栏。',
  'Controls when to show the inline suggestion toolbar.': '控制何时显示内联建议工具栏。',
  ...
  'Controls the font family of the inline suggestions.': '控制内联建议的字体系列。',
  ...
  'Enables bracket pair guides.': '启用括号对参考线。',
  'Enables bracket pair guides only for the active bracket pair.':
    '仅为活动括号对启用括号对参考线。',
  'Disables bracket pair guides.': '禁用括号对参考线。',
  'Controls whether bracket pair guides are enabled or not.': '控制是否启用括号对指南。',
  'Enables horizontal guides as addition to vertical bracket pair guides.':
    '启用水平参考线作为垂直括号对参考线的添加项。',
  'Enables horizontal guides only for the active bracket pair.': '仅为活动括号对启用水平参考线。',
  'Disables horizontal bracket pair guides.': '禁用水平括号对参考线。',
  'Controls whether horizontal bracket pair guides are enabled or not.':
    '控制是否启用水平括号对指南。',
  'Controls whether the editor should highlight the active bracket pair.':
    '控制编辑器是否应突出显示活动的括号对。',
  'Controls whether the editor should render indent guides.': '控制编辑器是否显示缩进参考线。',
  'Highlights the active indent guide.': '突出显示活动缩进参考线。',
  'Highlights the active indent guide even if bracket guides are highlighted.':
    '突出显示活动缩进参考线，即使突出显示了括号参考线。',
  'Do not highlight the active indent guide.': '不要突出显示活动缩进参考线。',
  ...
  'Controls whether an active snippet prevents quick suggestions.':
    '控制活动代码段是否阻止快速建议。',
  'Controls whether to show or hide icons in suggestions.': '控制是否在建议中显示或隐藏图标。',
  ...
  'When enabled IntelliSense shows `field`-suggestions.': '启用后，IntelliSense 将显示“字段”建议。',
  'When enabled IntelliSense shows `variable`-suggestions.':
    '启用后，IntelliSense 将显示“变量”建议。',
  'When enabled IntelliSense shows `class`-suggestions.': '启用后，IntelliSense 将显示“类”建议。',
  ...
  'When enabled IntelliSense shows `event`-suggestions.': '启用后，IntelliSense 将显示“事件”建议。',
  'When enabled IntelliSense shows `operator`-suggestions.':
    '启用后，IntelliSense 将显示“操作符”建议。',
  'When enabled IntelliSense shows `unit`-suggestions.': '启用后，IntelliSense 将显示“单位”建议。',
  'When enabled IntelliSense shows `value`-suggestions.': '启用后，IntelliSense 将显示“值”建议。',
  'When enabled IntelliSense shows `constant`-suggestions.':
    '启用后，IntelliSense 将显示“常量”建议。',
  'When enabled IntelliSense shows `enum`-suggestions.': '启用后，IntelliSense 将显示“枚举”建议。',
  'When enabled IntelliSense shows `enumMember`-suggestions.':
    '启用后，IntelliSense 将显示 "enumMember" 建议。',
  'When enabled IntelliSense shows `keyword`-suggestions.':
    '启用后，IntelliSense 将显示“关键字”建议。',
  'When enabled IntelliSense shows `text`-suggestions.': '启用后，IntelliSense 将显示“文本”建议。',
  'When enabled IntelliSense shows `color`-suggestions.': '启用后，IntelliSense 将显示“颜色”建议。',
  'When enabled IntelliSense shows `file`-suggestions.': '启用后，IntelliSense 将显示“文件”建议。',
  ...
  'When enabled IntelliSense shows `user`-suggestions.': '启用后，IntelliSense 将显示"用户"建议。',
  ...
  'No indentation. Wrapped lines begin at column 1.': '没有缩进。折行从第 1 列开始。',
  'Wrapped lines get the same indentation as the parent.': '折行的缩进量与其父级相同。',
  'Wrapped lines get +1 indentation toward the parent.': '折行的缩进量比其父级多 1。',
  'Wrapped lines get +2 indentation toward the parent.': '折行的缩进量比其父级多 2。',
  'Controls the indentation of wrapped lines.': '控制折行的缩进。',
  ...
  'Controls whether you can paste content in different ways.': '控制是否可以以不同的方式粘贴内容。',
  ...
  "The editor will keep the current line's indentation.": '编辑器将保留当前行的缩进。',
  ...
  'Use language configurations to determine when to automatically surround selections.':
    '使用语言配置确定何时自动包住所选内容。',
  'Surround with quotes but not brackets.': '使用引号而非括号来包住所选内容。',
  'Surround with brackets but not quotes.': '使用括号而非引号来包住所选内容。',
  'Controls whether the editor should automatically surround selections when typing quotes or brackets.':
    '控制在键入引号或方括号时，编辑器是否应自动将所选内容括起来。',
  'Emulate selection behavior of tab characters when using spaces for indentation. Selection will stick to tab stops.':
    '在使用空格进行缩进时模拟制表符的选择行为。所选内容将始终使用制表符停止位。',
  'Controls whether the editor shows CodeLens.': '控制是否在编辑器中显示 CodeLens。',
  'Controls the font family for CodeLens.': '控制 CodeLens 的字体系列。',
  ...
  'Make the color picker appear on hover of the color decorator':
    '使颜色选取器在颜色修饰器悬停时显示',
  'Make the color picker appear on click of the color decorator': '单击颜色修饰器时显示颜色选取器',
  ...
  'Controls whether syntax highlighting should be copied into the clipboard.':
    '控制在复制时是否同时复制语法高亮。',
  'Control the cursor animation style.': '控制光标的动画样式。',
  'Smooth caret animation is disabled.': '已禁用平滑脱字号动画。',
  'Smooth caret animation is enabled only when the user moves the cursor with an explicit gesture.':
    '仅当用户使用显式手势移动光标时，才启用平滑脱字号动画。',
  'Smooth caret animation is always enabled.': '始终启用平滑脱字号动画。',
  'Controls whether the smooth caret animation should be enabled.': '控制是否启用平滑插入动画。',
  'Controls the cursor style.': '在插入输入模式下控制光标样式。',
  ...
  '`cursorSurroundingLines` is enforced always.': '始终强制执行 "cursorSurroundingLines"',
  ...
  'Use a new rendering method with svgs.': '将新的呈现方法与 svg 配合使用。',
  'Use a new rendering method with font characters.': '使用包含字体字符的新呈现方法。',
  'Use the stable rendering method.': '使用稳定呈现方法。',
  'Controls whether whitespace is rendered with a new, experimental method.':
    '控制是否使用新的实验性方法呈现空格。',
  'Scrolling speed multiplier when pressing `Alt`.': '按下"Alt"时滚动速度倍增。',
  ...
  'Controls the font family.': '控制字体系列。',
  ...
  'Controls whether the cursor should be hidden in the overview ruler.':
    '控制是否在概览标尺中隐藏光标。',
  'Controls the letter spacing in pixels.': '控制字母间距(像素)。',
  ...
  'Highlight matching brackets.': '突出显示匹配的括号。',
  ...
  'Merge multiple cursors when they are overlapping.': '当多个光标重叠时进行合并。',
  ...
  'Each cursor pastes the full text.': '每个光标粘贴全文。',
  ...
  'Does not highlight occurrences.': '不突出显示出现次数。',
  'Highlights occurrences only in the current file.': '仅突出显示当前文件中的出现次数。',
  ...
  'Controls whether a border should be drawn around the overview ruler.':
    '控制是否在概览标尺周围绘制边框。',
  'Focus the tree when opening peek': '打开速览时聚焦树',
  'Focus the editor when opening peek': '打开预览时将焦点放在编辑器上',
  ...
  'Controls the delay in milliseconds after which quick suggestions will show up.':
    '控制显示快速建议前的等待时间 (毫秒)。',
  'Controls whether the editor auto renames on type.': '控制是否在编辑器中输入时自动重命名。',
  'Deprecated, use `editor.linkedEditing` instead.': '已弃用，请改用 "editor.linkedEditing"。',
  'Controls whether the editor should render control characters.': '控制编辑器是否显示控制字符。',
  'Render last line number when the file ends with a newline.':
    '当文件以换行符结束时, 呈现最后一行的行号。',
  'Highlights both the gutter and the current line.': '同时突出显示导航线和当前行。',
  ...
  'Render only trailing whitespace characters.': '仅呈现尾随空格字符。',
  'Controls how the editor should render whitespace characters.':
    '控制编辑器在空白字符上显示符号的方式。',
  'Controls whether selections should have rounded corners.': '控制选区是否有圆角。',
  ...
  'Only show the folding controls when the mouse is over the gutter.':
    '仅在鼠标位于装订线上方时显示折叠控件。',
  'Controls when the folding controls on the gutter are shown.': '控制何时显示行号槽上的折叠控件。',
  'Controls fading out of unused code.': '控制是否淡化未使用的代码。',
  'Controls strikethrough deprecated variables.': '控制加删除线被弃用的变量。',
  'Show snippet suggestions on top of other suggestions.': '在其他建议上方显示代码片段建议。',
  'Show snippet suggestions below other suggestions.': '在其他建议下方显示代码片段建议。',
  'Show snippets suggestions with other suggestions.': '在其他建议中穿插显示代码片段建议。',
  'Do not show snippet suggestions.': '不显示代码片段建议。',
  ...
  'Disable tab completions.': '禁用 Tab 补全。',
  "Tab complete snippets when their prefix match. Works best when 'quickSuggestions' aren't enabled.":
    '在前缀匹配时进行 Tab 补全。在 "quickSuggestions" 未启用时体验最好。',
  'Enables tab completions.': '启用 Tab 补全。',
  'Unusual line terminators are automatically removed.': '自动删除异常的行终止符。',
  'Unusual line terminators are ignored.': '忽略异常的行终止符。',
  'Unusual line terminators prompt to be removed.': '提示删除异常的行终止符。',
  ...
  'Spaces and tabs are inserted and deleted in alignment with tab stops.':
    '空格和制表符的插入和删除与制表位对齐。',
  'Use the default line break rule.': '使用默认换行规则。',
  ...
  'Lines will never wrap.': '永不换行。',
  'Lines will wrap at the viewport width.': '将在视区宽度处换行。',
  'Lines will wrap at `#editor.wordWrapColumn#`.': '在 `#editor.wordWrapColumn#` 处折行。',
  'Lines will wrap at the minimum of viewport and `#editor.wordWrapColumn#`.':
    '在视区宽度和 `#editor.wordWrapColumn#` 中的较小值处折行。',
  'Controls how lines should wrap.': '控制折行的方式。',
  ...
  Typing: '输入',
  'Developer: Inspect Tokens': '开发人员: 检查令牌',
  'Go to Line/Column...': '转到行/列...',
  'Show all Quick Access Providers': '显示所有快速访问提供程序',
  'Command Palette': '命令面板',
  'Show And Run Commands': '显示并运行命令',
  'Go to Symbol...': '转到符号...',
  'Go to Symbol by Category...': '按类别转到符号...',
  'Toggle High Contrast Theme': '切换高对比度主题',
  'Made {0} edits in {1} files': '在 {1} 个文件中进行了 {0} 次编辑',
  'Show more ({0})': '显示更多({0})',
  '{0} chars': '{0} 字符',
  'Increase Hover Verbosity Level': '提高悬停详细程度级别',
  'Decrease Hover Verbosity Level': '降低悬停详细程度级别',
  'Whether the editor text has focus (cursor is blinking)': '编辑器文本是否具有焦点(光标是否闪烁)',
  ...
  'Whether the context is a diff editor': '上下文是否为差异编辑器',
  'Whether the context is an embedded diff editor': '上下文是否为嵌入式差异编辑器',
  'Whether all files in multi diff editor are collapsed': '是否折叠多差异编辑器中的所有文件',
  'Whether the diff editor has changes': '差异编辑器是否有更改',
  'Whether a moved code block is selected for comparison': '是否选择移动的代码块进行比较',
  'Whether the accessible diff viewer is visible': '可访问差异查看器是否可见',
  'Whether the diff editor render side by side inline breakpoint is reached':
    '是否已到达差异编辑器并排呈现内联断点',
  'Whether inline mode is active': '内联模式是否处于活动状态',
  'Whether modified is writable in the diff editor': '修改项在差异编辑器是否可写',
  'The uri of the original document': '原始文档的 URI',
  'The uri of the modified document': '已修改的文档的 URI',
  'Whether `editor.columnSelection` is enabled': '是否已启用 "editor.columnSelection"',
  'Whether the editor has text selected': '编辑器是否已选定文本',
  'Whether the editor has multiple selections': '编辑器是否有多个选择',
  'Whether `Tab` will move focus out of the editor': '"Tab" 是否将焦点移出编辑器',
  'Whether the editor hover is visible': '编辑器软键盘是否可见',
  'Whether the editor hover is focused': '是否聚焦编辑器悬停',
  'Whether the sticky scroll is focused': '是否聚焦粘性滚动',
  'Whether the sticky scroll is visible': '粘性滚动是否可见',
  'Whether the standalone color picker is visible': '独立颜色选取器是否可见',
  'Whether the standalone color picker is focused': '独立颜色选取器是否聚焦',
  ...
  'Whether the editor has a completion item provider': '编辑器是否具有补全项提供程序',
  'Whether the editor has a code actions provider': '编辑器是否具有代码操作提供程序',
  'Whether the editor has a code lens provider': '编辑器是否具有 CodeLens 提供程序',
  ...
  'Whether the editor has a document highlight provider': '编辑器是否具有文档突出显示提供程序',
  ...
  'Whether the editor has a document formatting provider': '编辑器是否具有文档格式设置提供程序',
  ...
  '({0}) was pressed. Waiting for second key of chord...': '({0})已按下。正在等待按下第二个键...',
  '({0}) was pressed. Waiting for next key of chord...': '已按下({0})。正在等待第二个键...',
  'The key combination ({0}, {1}) is not a command.': '组合键({0}，{1})不是命令。',
  'Default Language Configuration Overrides': '默认语言配置替代',
  'Configure settings to be overridden for the {0} language.': '配置要为 {0} 语言替代的设置。',
  'Configure editor settings to be overridden for a language.':
    '针对某种语言，配置替代编辑器设置。',
  'This setting does not support per-language configuration.': '此设置不支持按语言配置。',
  ...
  'Remove trailing auto inserted whitespace.': '删除自动插入的尾随空白符号。',
  'Special handling for large files to disable certain memory intensive features.':
    '对大型文件进行特殊处理，禁用某些内存密集型功能。',
  'Turn off Word Based Suggestions.': '关闭基于字词的建议。',
  'Only suggest words from the active document.': '仅建议活动文档中的字词。',
  'Suggest words from all open documents of the same language.':
    '建议使用同一语言的所有打开的文档中的字词。',
  'Suggest words from all open documents.': '建议所有打开的文档中的字词。',
  ...
  'Semantic highlighting enabled for all color themes.': '对所有颜色主题启用语义突出显示。',
  'Semantic highlighting disabled for all color themes.': '对所有颜色主题禁用语义突出显示。',
  ...
  'Defines the bracket symbols that increase or decrease the indentation.':
    '定义增加和减少缩进的括号。',
  'The opening bracket character or string sequence.': '左方括号字符或字符串序列。',
  'The closing bracket character or string sequence.': '右方括号字符或字符串序列。',
  ...
  'Lines will wrap according to the {0} setting.': '行将根据 {0} 设置进行换行。',
  'Uses the legacy diffing algorithm.': '使用旧差异算法。',
  'Uses the advanced diffing algorithm.': '使用高级差异算法。',
  'Controls whether the diff editor shows unchanged regions.':
    '控制差异编辑器是否显示未更改的区域。',
  'Controls how many lines are used for unchanged regions.': '控制用于未更改区域的行数。',
  ...
  Close: '关闭',
  'Loading...': '正在加载...',
  'Toggle Tab Key Moves Focus': '切换 Tab 键移动焦点',
  ...
  'Pressing Tab will now move focus to the next focusable element':
    'Tab 键将移动到下一可聚焦的元素',
  'Pressing Tab will now insert the tab character': 'Tab 键将插入制表符',
  '&&Undo': '撤消(&&U)',
  Undo: '撤消',
  '&&Redo': '恢复(&&R)',
  Redo: '恢复',
  '&&Select All': '全选(&&S)',
  'Select All': '选择全部',
  'Stick to the end even when going to longer lines': '即使转到较长的行，也一直到末尾',
  'Removed secondary cursors': '已删除辅助游标',
  'Move Selected Text Left': '向左移动所选文本',
  'Move Selected Text Right': '向右移动所选文本',
  'Transpose Letters': '转置字母',
  'Toggle Line Comment': '切换行注释',
  '&&Toggle Line Comment': '切换行注释(&&T)',
  'Add Line Comment': '添加行注释',
  'Remove Line Comment': '删除行注释',
  'Toggle Block Comment': '切换块注释',
  'Toggle &&Block Comment': '切换块注释(&&B)',
  'Cursor Undo': '光标撤消',
  'Cursor Redo': '光标重做',
  'An unknown error occurred while applying the code action': '应用代码操作时发生未知错误',
  'Increase Editor Font Size': '增大编辑器字号',
  'Decrease Editor Font Size': '减小编辑器字号',
  'Reset Editor Font Size': '重置编辑器字号',
  'Format Document': '格式化文档',
  'Format Selection': '格式化选定内容',
  'Convert Indentation to Spaces': '将缩进转换为空格',
  'Convert the tab indentation to spaces.': '将制表符缩进转换为空格。',
  'Convert Indentation to Tabs': '将缩进转换为制表符',
  'Convert the spaces indentation to tabs.': '将空格缩进转换为制表符。',
  'Configured Tab Size': '已配置制表符大小',
  'Default Tab Size': '默认选项卡大小',
  'Current Tab Size': '当前选项卡大小',
  'Select Tab Size for Current File': '选择当前文件的制表符大小',
  'Indent Using Tabs': '使用制表符缩进',
  'Use indentation with tabs.': '使用制表符缩进。',
  'Indent Using Spaces': '使用空格缩进',
  'Use indentation with spaces.': '使用空格缩进。',
  'Change Tab Display Size': '更改制表符显示大小',
  'Change the space size equivalent of the tab.': '更改制表符的等效空间大小。',
  'Detect Indentation from Content': '从内容中检测缩进方式',
  'Detect the indentation from content.': '检测内容的缩进。',
  'Reindent Lines': '重新缩进行',
  'Reindent the lines of the editor.': '重新设计编辑器的行缩进。',
  'Reindent Selected Lines': '重新缩进所选行',
  'Reindent the selected lines of the editor.': '重新设计编辑器所选行的缩进。',
  'Expand Line Selection': '展开行选择',
  'Copy Line Up': '向上复制行',
  '&&Copy Line Up': '向上复制一行(&&C)',
  'Copy Line Down': '向下复制行',
  'Co&&py Line Down': '向下复制一行(&&P)',
  'Duplicate Selection': '重复选择',
  '&&Duplicate Selection': '重复选择(&&D)',
  'Move Line Up': '向上移动行',
  'Mo&&ve Line Up': '向上移动一行(&&V)',
  'Move Line Down': '向下移动行',
  'Move &&Line Down': '向下移动一行(&&L)',
  'Sort Lines Ascending': '按升序排列行',
  'Sort Lines Descending': '按降序排列行',
  'Delete Duplicate Lines': '删除重复行',
  'Trim Trailing Whitespace': '裁剪尾随空格',
  'Delete Line': '删除行',
  'Indent Line': '行缩进',
  'Outdent Line': '行减少缩进',
  'Insert Line Above': '在上面插入行',
  'Insert Line Below': '在下面插入行',
  'Delete All Left': '删除左侧所有内容',
  'Delete All Right': '删除右侧所有内容',
  'Join Lines': '合并行',
  'Transpose Characters around the Cursor': '转置光标处的字符',
  'Transform to Uppercase': '转换为大写',
  'Transform to Lowercase': '转换为小写',
  'Transform to Title Case': '转换为词首字母大写',
  'Transform to Snake Case': '转换为蛇形命名法',
  'Transform to Camel Case': '转换为驼峰式大小写',
  'Transform to Pascal Case': '转换为帕斯卡式大小写形式',
  'Transform to Kebab Case': '转换为 Kebab 案例',
  'Whether the editor is currently showing an inline message': '编辑器当前是否正在显示内联消息',
  'Cannot edit in read-only input': '无法在只读输入中编辑',
  'Cannot edit in read-only editor': '无法在只读编辑器中编辑',
  'Expand Selection': '展开选择',
  '&&Expand Selection': '扩大选区(&&E)',
  'Shrink Selection': '收起选择',
  '&&Shrink Selection': '缩小选区(&&S)',
  'Developer: Force Retokenize': '开发人员: 强制重新进行标记',
  'Unusual Line Terminators': '异常行终止符',
  'Detected unusual line terminators': '检测到异常行终止符',
  ...
  '&&Remove Unusual Line Terminators': '删除异常行终止符(&&R)',
  Ignore: '忽略',
  'Delete Word': '删除 Word',
  'This color must be transparent or it will obscure content': '此颜色必须是透明的，否则会遮盖内容',
  ...
  'The default color for icons in the workbench.': '工作台中图标的默认颜色。',
  ...
  'Foreground color for links in text when clicked on and on mouse hover.':
    '文本中链接在点击或鼠标悬停时的前景色 。',
  'Color for text separators.': '文字分隔符的颜色。',
  'Foreground color for preformatted text segments.': '预格式化文本段的前景色。',
  'Background color for preformatted text segments.': '预格式化文本段的背景色。',
  ...
  'Border color of active sashes.': '活动框格的边框颜色。',
  ...
  'Scrollbar shadow to indicate that the view is scrolled.': '表示视图被滚动的滚动条阴影。',
  'Scrollbar slider background color.': '滚动条滑块背景色',
  'Scrollbar slider background color when hovering.': '滚动条滑块在悬停时的背景色',
  'Scrollbar slider background color when clicked on.': '滚动条滑块在被点击时的背景色。',
  'Background color of the progress bar that can show for long running operations.':
    '表示长时间操作的进度条的背景色。',
  'Editor background color.': '编辑器背景色。',
  'Editor default foreground color.': '编辑器默认前景色。',
  'Background color of sticky scroll in the editor': '编辑器中粘滞滚动的背景色',
  'Background color of sticky scroll on hover in the editor': '在编辑器中悬停时粘滞滚动的背景色',
  'Border color of sticky scroll in the editor': '编辑器中粘滞滚动的边框颜色',
  ' Shadow color of sticky scroll in the editor': ' 编辑器中粘滞滚动的阴影颜色',
  'Background color of editor widgets, such as find/replace.': '编辑器组件(如查找/替换)背景颜色。',
  ...
  'Foreground color of error squigglies in the editor.': '编辑器中错误波浪线的前景色。',
  ...
  'Foreground color of warning squigglies in the editor.': '编辑器中警告波浪线的前景色。',
  ...
  'Foreground color of info squigglies in the editor.': '编辑器中信息波浪线的前景色。',
  'If set, color of double underlines for infos in the editor.':
    '如果设置，编辑器中信息的双下划线颜色。',
  'Foreground color of hint squigglies in the editor.': '编辑器中提示波浪线的前景色。',
  'If set, color of double underlines for hints in the editor.':
    '如果设置，编辑器中提示的双下划线颜色。',
  'Color of active links.': '活动链接颜色。',
  'Color of the editor selection.': '编辑器所选内容的颜色。',
  'Color of the selected text for high contrast.': '用以彰显高对比度的所选文本的颜色。',
  ...
  'Border color for regions with the same content as the selection.':
    '与所选项内容相同的区域的边框颜色。',
  'Color of the current search match.': '当前搜索匹配项的颜色。',
  'Text color of the current search match.': '当前搜索匹配项的文本颜色。',
  'Color of the other search matches. The color must not be opaque so as not to hide underlying decorations.':
    '其他搜索匹配项的颜色。颜色必须透明，以免隐藏下面的修饰效果。',
  'Foreground color of the other search matches.': '其他搜索匹配项的前景色。',
  ...
  'Border color of the current search match.': '当前搜索匹配项的边框颜色。',
  'Border color of the other search matches.': '其他搜索匹配项的边框颜色。',
  ...
  'Background color of the editor hover.': '编辑器悬停提示的背景颜色。',
  'Foreground color of the editor hover.': '编辑器悬停的前景颜色。',
  'Border color of the editor hover.': '光标悬停时编辑器的边框颜色。',
  ...
  'Foreground color of inline hints for types': '类型内联提示的前景色',
  'Background color of inline hints for types': '类型内联提示的背景色',
  'Foreground color of inline hints for parameters': '参数内联提示的前景色',
  'Background color of inline hints for parameters': '参数内联提示的背景色',
  'The color used for the lightbulb actions icon.': '用于灯泡操作图标的颜色。',
  'The color used for the lightbulb auto fix actions icon.': '用于灯泡自动修复操作图标的颜色。',
  'The color used for the lightbulb AI icon.': '用于灯泡 AI 图标的颜色。',
  'Highlight background color of a snippet tabstop.': '代码片段 Tab 位的高亮背景色。',
  'Highlight border color of a snippet tabstop.': '代码片段 Tab 位的高亮边框颜色。',
  ...
  'Background color for the margin where lines got inserted.': '插入行的边距的背景色。',
  'Background color for the margin where lines got removed.': '删除行的边距的背景色。',
  'Diff overview ruler foreground for inserted content.': '插入内容的差异概述标尺前景。',
  'Diff overview ruler foreground for removed content.': '删除内容的差异概述标尺前景。',
  'Outline color for the text that got inserted.': '插入的文本的轮廓颜色。',
  'Outline color for text that got removed.': '被删除文本的轮廓颜色。',
  'Border color between the two text editors.': '两个文本编辑器之间的边框颜色。',
  "Color of the diff editor's diagonal fill. The diagonal fill is used in side-by-side diff views.":
    '差异编辑器的对角线填充颜色。对角线填充用于并排差异视图。',
  'The background color of unchanged blocks in the diff editor.': '差异编辑器中未更改块的背景色。',
  'The foreground color of unchanged blocks in the diff editor.': '差异编辑器中未更改块的前景色。',
  'The background color of unchanged code in the diff editor.': '差异编辑器中未更改代码的背景色。',
  ...
  'Toolbar outline when hovering over actions using the mouse':
    '使用鼠标悬停在操作上时显示工具栏轮廓',
  'Toolbar background when holding the mouse over actions': '将鼠标悬停在操作上时的工具栏背景',
  'Color of focused breadcrumb items.': '焦点导航路径的颜色',
  'Background color of breadcrumb items.': '导航路径项的背景色。',
  'Color of selected breadcrumb items.': '已选导航路径项的颜色。',
  'Background color of breadcrumb item picker.': '导航路径项选择器的背景色。',
  ...
  'Input box background.': '输入框背景色。',
  'Input box foreground.': '输入框前景色。',
  'Input box border.': '输入框边框。',
  'Border color of activated options in input fields.': '输入字段中已激活选项的边框颜色。',
  'Background color of activated options in input fields.': '输入字段中激活选项的背景颜色。',
  'Background hover color of options in input fields.': '输入字段中选项的背景悬停颜色。',
  'Foreground color of activated options in input fields.': '输入字段中已激活的选项的前景色。',
  'Input box foreground color for placeholder text.': '输入框中占位符的前景色。',
  'Input validation background color for information severity.':
    '输入验证结果为信息级别时的背景色。',
  'Input validation foreground color for information severity.':
    '输入验证结果为信息级别时的前景色。',
  'Input validation border color for information severity.': '严重性为信息时输入验证的边框颜色。',
  'Input validation background color for warning severity.': '严重性为警告时输入验证的背景色。',
  'Input validation foreground color for warning severity.': '输入验证结果为警告级别时的前景色。',
  'Input validation border color for warning severity.': '严重性为警告时输入验证的边框颜色。',
  'Input validation background color for error severity.': '输入验证结果为错误级别时的背景色。',
  'Input validation foreground color for error severity.': '输入验证结果为错误级别时的前景色。',
  'Input validation border color for error severity.': '严重性为错误时输入验证的边框颜色。',
  'Dropdown background.': '下拉列表背景色。',
  'Dropdown list background.': '下拉列表背景色。',
  'Dropdown foreground.': '下拉列表前景色。',
  'Dropdown border.': '下拉列表边框。',
  'Button foreground color.': '按钮前景色。',
  'Button separator color.': '按钮分隔符颜色。',
  'Button background color.': '按钮背景色。',
  'Button background color when hovering.': '按钮在悬停时的背景颜色。',
  'Button border color.': '按钮边框颜色。',
  'Secondary button foreground color.': '辅助按钮前景色。',
  'Secondary button background color.': '辅助按钮背景色。',
  'Secondary button background color when hovering.': '悬停时的辅助按钮背景色。',
  'Foreground color of active radio option.': '活动单选选项的前景色。',
  'Background color of active radio option.': '活动单选选项的背景色。',
  'Border color of the active radio option.': '活动单选选项的边框颜色。',
  'Foreground color of inactive radio option.': '非活动单选选项的前景色。',
  'Background color of inactive radio option.': '非活动单选选项的背景色。',
  'Border color of the inactive radio option.': '非活动单选选项的边框颜色。',
  'Background color of inactive active radio option when hovering.':
    '悬停时非活动单选选项的背景色。',
  'Background color of checkbox widget.': '复选框小部件的背景颜色。',
  "Background color of checkbox widget when the element it's in is selected.":
    '选择复选框小组件所在的元素时该小组件的背景色。',
  'Foreground color of checkbox widget.': '复选框小部件的前景色。',
  'Border color of checkbox widget.': '复选框小部件的边框颜色。',
  ...
  'Foreground color of list items containing errors.': '包含错误的列表项的前景颜色。',
  'Foreground color of list items containing warnings.': '包含警告的列表项的前景颜色。',
  ...
  'Shadow color of the type filter widget in lists and trees.':
    '列表和树中类型筛选器小组件的阴影颜色。',
  'Background color of the filtered match.': '筛选后的匹配项的背景颜色。',
  'Border color of the filtered match.': '筛选后的匹配项的边框颜色。',
  'List/Tree foreground color for items that are deemphasized.': '取消强调的项的列表/树前景色。',
  'Tree stroke color for the indentation guides.': '缩进参考线的树描边颜色。',
  'Tree stroke color for the indentation guides that are not active.':
    '非活动缩进参考线的树描边颜色。',
  'Table border color between columns.': '列之间的表边框颜色。',
  'Background color for odd table rows.': '奇数表行的背景色。',
  'Action List background color.': '操作列表背景色。',
  'Action List foreground color.': '操作列表前景色。',
  'Action List foreground color for the focused item.': '聚焦项目的操作列表前景色。',
  'Action List background color for the focused item.': '聚焦项目的操作列表背景色。',
  'Border color of menus.': '菜单的边框颜色。',
  'Foreground color of menu items.': '菜单项的前景颜色。',
  'Background color of menu items.': '菜单项的背景颜色。',
  'Foreground color of the selected menu item in menus.': '菜单中选定菜单项的前景色。',
  'Background color of the selected menu item in menus.': '菜单中所选菜单项的背景色。',
  'Border color of the selected menu item in menus.': '菜单中所选菜单项的边框颜色。',
  'Color of a separator menu item in menus.': '菜单中分隔线的颜色。',
  'Minimap marker color for find matches.': '用于查找匹配项的迷你地图标记颜色。',
  'Minimap marker color for repeating editor selections.': '用于重复编辑器选择的缩略图标记颜色。',
  'Minimap marker color for the editor selection.': '编辑器选区在迷你地图中对应的标记颜色。',
  'Minimap marker color for infos.': '信息的迷你地图标记颜色。',
  'Minimap marker color for warnings.': '用于警告的迷你地图标记颜色。',
  'Minimap marker color for errors.': '用于错误的迷你地图标记颜色。',
  'Minimap background color.': '迷你地图背景颜色。',
  'Minimap slider background color.': '迷你地图滑块背景颜色。',
  'Minimap slider background color when hovering.': '悬停时，迷你地图滑块的背景颜色。',
  'Minimap slider background color when clicked on.': '单击时，迷你地图滑块的背景颜色。',
  'The foreground color used in charts.': '图表中使用的前景颜色。',
  'The color used for horizontal lines in charts.': '用于图表中的水平线条的颜色。',
  'The red color used in chart visualizations.': '图表可视化效果中使用的红色。',
  'The blue color used in chart visualizations.': '图表可视化效果中使用的蓝色。',
  'The yellow color used in chart visualizations.': '图表可视化效果中使用的黄色。',
  'The orange color used in chart visualizations.': '图表可视化效果中使用的橙色。',
  'The green color used in chart visualizations.': '图表可视化效果中使用的绿色。',
  'The purple color used in chart visualizations.': '图表可视化效果中使用的紫色。',
  ...
  'Quick picker color for grouping labels.': '快速选取器分组标签的颜色。',
  'Quick picker color for grouping borders.': '快速选取器分组边框的颜色。',
  'Please use quickInputList.focusBackground instead': '请改用 quickInputList.focusBackground',
  'Quick picker foreground color for the focused item.': '焦点项目的快速选择器前景色。',
  'Quick picker icon foreground color for the focused item.': '焦点项目的快速选取器图标前景色。',
  'Quick picker background color for the focused item.': '焦点项目的快速选择器背景色。',
  "Color of the text in the search viewlet's completion message.":
    '搜索 Viewlet 完成消息中文本的颜色。',
  'Color of the Search Editor query matches.': '搜索编辑器查询匹配的颜色。',
  'Border color of the Search Editor query matches.': '搜索编辑器查询匹配的边框颜色。',
  'Icon for increaseing hover verbosity.': '用于提高悬停详细程度的图标。',
  'Icon for decreasing hover verbosity.': '用于降低悬停详细程度的图标。',
  ...
  'Increase Hover Verbosity ({0})': '提高悬停详细程度({0})',
  'Increase Hover Verbosity': '提高悬停详细程度',
  'Decrease Hover Verbosity ({0})': '降低悬停详细程度({0})',
  'Decrease Hover Verbosity': '降低悬停详细程度',
  'Icon for show next parameter hint.': '“显示下一个参数”提示的图标。',
  'Icon for show previous parameter hint.': '“显示上一个参数”提示的图标。',
  '{0}, hint': '{0}，提示',
  'Foreground color of the active item in the parameter hint.': '参数提示中活动项的前景色。',
  ...
  'Background color of the border around highlighted ranges.': '高亮区域边框的背景颜色。',
  ...
  'Background color of the border around highlighted symbols.':
    '高亮显示符号周围的边框的背景颜色。',
  'Color of the editor cursor.': '编辑器光标颜色。',
  ...
  'Color of the editor indentation guides.': '编辑器缩进参考线的颜色。',
  ...
  'Color of the active editor indentation guides.': '编辑器活动缩进参考线的颜色。',
  "'editorIndentGuide.activeBackground' is deprecated. Use 'editorIndentGuide.activeBackground1' instead.":
    '“editorIndentGuide.activeBackground” 已弃用。请改用 “editorIndentGuide.activeBackground1”。',
  'Color of the editor indentation guides (1).': '编辑器缩进参考线 (1) 的颜色。',
  'Color of the editor indentation guides (2).': '编辑器缩进参考线 (2) 的颜色。',
  'Color of the editor indentation guides (3).': '编辑器缩进参考线 (3) 的颜色。',
  'Color of the editor indentation guides (4).': '编辑器缩进参考线 (4) 的颜色。',
  'Color of the editor indentation guides (5).': '编辑器缩进参考线 (5) 的颜色。',
  'Color of the editor indentation guides (6).': '编辑器缩进参考线 (6) 的颜色。',
  'Color of the active editor indentation guides (1).': '编辑器活动缩进参考线 (1) 的颜色。',
  'Color of the active editor indentation guides (2).': '编辑器活动缩进参考线 (2) 的颜色。',
  'Color of the active editor indentation guides (3).': '编辑器活动缩进参考线 (3) 的颜色。',
  'Color of the active editor indentation guides (4).': '编辑器活动缩进参考线 (4) 的颜色。',
  'Color of the active editor indentation guides (5).': '编辑器活动缩进参考线 (5) 的颜色。',
  'Color of the active editor indentation guides (6).': '编辑器活动缩进参考线 (6) 的颜色。',
  ...
  'Background color behind matching brackets': '匹配括号的背景色',
  'Color for matching brackets boxes': '匹配括号外框的颜色',
  'Color of the overview ruler border.': '概览标尺边框的颜色。',
  'Background color of the editor overview ruler.': '编辑器概述标尺的背景色。',
  ...
  'Border color of ghost text in the editor.': '编辑器中虚影文本的边框颜色。',
  'Foreground color of the ghost text in the editor.': '编辑器中虚影文本的前景色。',
  'Background color of the ghost text in the editor.': '编辑器中虚影文本的背景色。',
  ...
  'Overview ruler marker color for errors.': '概览标尺中错误标记的颜色。',
  'Overview ruler marker color for warnings.': '概览标尺中警告标记的颜色。',
  'Overview ruler marker color for infos.': '概览标尺中信息标记的颜色。',
  ...
  'Foreground color of brackets (6). Requires enabling bracket pair colorization.':
    '括号的前景色(6)。需要启用括号对着色。',
  'Foreground color of unexpected brackets.': '方括号出现意外的前景色。',
  ...
  'Border color used to highlight unicode characters.': '用于突出显示 Unicode 字符的边框颜色。',
  'Background color used to highlight unicode characters.': '用于突出显示 Unicode 字符的背景颜色。',
  'Whether the rename input widget is visible': '重命名输入小组件是否可见',
  'Whether the rename input widget is focused': '是否聚焦重命名输入小组件',
  '{0} to Rename, {1} to Preview': '按 {0} 进行重命名，按 {1} 进行预览',
  'Received {0} rename suggestions': '已收到 {0} 重命名建议',
  'Rename input. Type new name and press Enter to commit.':
    '重命名输入。键入新名称并按 "Enter" 提交。',
  'Generate new name suggestions': '生成新的名称建议',
  Cancel: '取消',
  'No result.': '无结果。',
  'An unknown error occurred while resolving rename location': '解析重命名位置时发生未知错误',
  "Renaming '{0}' to '{1}'": '正在将“{0}”重命名为“{1}”',
  'Renaming {0} to {1}': '将 {0} 重命名为 {1}',
  "Successfully renamed '{0}' to '{1}'. Summary: {2}": '成功将“{0}”重命名为“{1}”。摘要: {2}',
  'Rename failed to apply edits': '重命名无法应用修改',
  'Rename failed to compute edits': '重命名无法计算修改',
  'Rename Symbol': '重命名符号',
  'Focus Next Rename Suggestion': '聚焦下一个重命名建议',
  'Focus Previous Rename Suggestion': '聚焦上一个重命名建议',
  'Enable/disable the ability to preview changes before renaming':
    '启用/禁用重命名之前预览更改的功能',
  'Icon for more information in the suggest widget.': '建议小组件中的详细信息的图标。',
  'Read More': '了解详细信息',
  ...
  'Increase Multi Cursor Limit': '增加多光标限制',
  'Overview ruler marker color for matching brackets.': '概览标尺上表示匹配括号的标记颜色。',
  'Go to Bracket': '转到括号',
  'Select to Bracket': '选择括号所有内容',
  'Select the text inside and including the brackets or curly braces':
    '选择其中的文本，包括括号或大括号',
  'Remove Brackets': '删除括号',
  'Go to &&Bracket': '转到括号(&&B)',
  ...
  'Run: {0}': '运行：{0}',
  'Show Code Actions. Preferred Quick Fix Available ({0})': '显示代码操作。首选可用的快速修复({0})',
  'Show Code Actions ({0})': '显示代码操作({0})',
  'Show Code Actions': '显示代码操作',
  'Kind of the code action to run.': '要运行的代码操作的种类。',
  ...
  "No code actions for '{0}' available": '没有适用于"{0}"的代码操作',
  'No preferred code actions available': '没有可用的首选代码操作',
  'Refactor...': '重构...',
  "No preferred refactorings for '{0}' available": '没有适用于"{0}"的首选重构',
  "No refactorings for '{0}' available": '没有可用的"{0}"重构',
  'No preferred refactorings available': '没有可用的首选重构',
  'No refactorings available': '没有可用的重构操作',
  'Source Action...': '源代码操作...',
  "No preferred source actions for '{0}' available": '没有适用于"{0}"的首选源操作',
  "No source actions for '{0}' available": '没有适用于“ {0}”的源操作',
  'No preferred source actions available': '没有可用的首选源操作',
  'No source actions available': '没有可用的源代码操作',
  'Organize Imports': '整理 import 语句',
  'No organize imports action available': '没有可用的整理 import 语句操作',
  'Fix All': '全部修复',
  'No fix all action available': '没有可用的“全部修复”操作',
  'Auto Fix...': '自动修复...',
  'No auto fixes available': '没有可用的自动修复程序',
  ...
  "Icon for 'Replace' in the editor find widget.": '编辑器查找小组件中的“替换”图标。',
  "Icon for 'Replace All' in the editor find widget.": '编辑器查找小组件中的“全部替换”图标。',
  "Icon for 'Find Previous' in the editor find widget.": '编辑器查找小组件中的“查找上一个”图标。',
  "Icon for 'Find Next' in the editor find widget.": '编辑器查找小组件中的“查找下一个”图标。',
  'Find / Replace': '查找/替换',
  Find: '查找',
  ...
  'No results': '无结果',
  '{0} found': '找到 {0}',
  "{0} found for '{1}'": '为“{1}”找到 {0}',
  "{0} found for '{1}', at {2}": '在 {2} 处找到“{1}”的 {0}',
  ...
  'The file is too large to perform a replace all operation.': '文件太大，无法执行全部替换操作。',
  '&&Find': '查找(&&F)',
  'Find With Arguments': '使用参数查找',
  'Find With Selection': '查找选定内容',
  'Find Next': '查找下一个',
  'Find Previous': '查找上一个',
  'Go to Match...': '转到“匹配”...',
  'No matches. Try searching for something else.': '无匹配项。请尝试搜索其他内容。',
  'Type a number to go to a specific match (between 1 and {0})':
    '键入数字以转到特定匹配项(介于 1 和 {0} 之间)',
  'Please type a number between 1 and {0}': '请键入介于 1 和 {0} 之间的数字',
  'Find Next Selection': '查找下一个选择',
  'Find Previous Selection': '查找上一个选择',
  '&&Replace': '替换(&&R)',
  Unfold: '展开',
  'Unfold Recursively': '以递归方式展开',
  Fold: '折叠',
  'Toggle Fold': '切换折叠',
  'Fold Recursively': '以递归方式折叠',
  'Toggle Fold Recursively': '以递归方式切换折叠',
  'Fold All Block Comments': '折叠所有块注释',
  'Fold All Regions': '折叠所有区域',
  'Unfold All Regions': '展开所有区域',
  'Fold All Except Selected': '折叠除选定项以外的所有项',
  'Unfold All Except Selected': '展开除所选区域之外的所有区域',
  'Fold All': '全部折叠',
  'Unfold All': '全部展开',
  'Go to Parent Fold': '跳转到父级折叠',
  'Go to Previous Folding Range': '转到上一个折叠范围',
  'Go to Next Folding Range': '转到下一个折叠范围',
  'Create Folding Range from Selection': '根据所选内容创建折叠范围',
  'Remove Manual Folding Ranges': '删除手动折叠范围',
  'Fold Level {0}': '折叠级别 {0}',
  'Replace with Previous Value': '替换为上一个值',
  'Replace with Next Value': '替换为下一个值',
  'Start Linked Editing': '启动链接编辑',
  'Background color when the editor auto renames on type.': '编辑器根据类型自动重命名时的背景色。',
  'Failed to open this link because it is not well-formed: {0}': '此链接格式不正确，无法打开: {0}',
  'Failed to open this link because its target is missing.': '此链接目标已丢失，无法打开。',
  'Execute command': '执行命令',
  'Follow link': '打开链接',
  'cmd + click': 'cmd + 单击',
  'ctrl + click': 'ctrl + 单击',
  'option + click': 'option + 单击',
  'alt + click': 'alt + 单击',
  'Execute command {0}': '执行命令 {0}',
  'Open Link': '打开链接',
  'Background color of the suggest widget.': '建议小组件的背景色。',
  'Border color of the suggest widget.': '建议小组件的边框颜色。',
  'Foreground color of the suggest widget.': '建议小组件的前景色。',
  'Foreground color of the selected entry in the suggest widget.': '建议小组件中所选条目的前景色。',
  'Icon foreground color of the selected entry in the suggest widget.':
    '建议小组件中所选条目的图标前景色。',
  'Background color of the selected entry in the suggest widget.': '建议小组件中所选条目的背景色。',
  'Color of the match highlights in the suggest widget.': '建议小组件中匹配内容的高亮颜色。',
  'Color of the match highlights in the suggest widget when an item is focused.':
    '当某项获得焦点时，在建议小组件中突出显示的匹配项的颜色。',
  'Foreground color of the suggest widget status.': '建议小组件状态的前景色。',
  'No suggestions.': '无建议。',
  Suggest: '建议',
  '{0} {1}, {2}': '{0} {1}，{2}',
  '{0} {1}': '{0} {1}',
  ...
  'Border color of a textual occurrence for a symbol.': '符号在文本中出现时的边框颜色。',
  ...
  'Cursor added: {0}': '添加的光标: {0}',
  'Cursors added: {0}': '添加的游标: {0}',
  'Add Cursor Above': '在上面添加光标',
  '&&Add Cursor Above': '在上面添加光标(&&A)',
  'Add Cursor Below': '在下面添加光标',
  'A&&dd Cursor Below': '在下面添加光标(&&D)',
  'Add Cursors to Line Ends': '在行尾添加光标',
  'Add C&&ursors to Line Ends': '在行尾添加光标(&&U)',
  'Add Cursors To Bottom': '在底部添加光标',
  'Add Cursors To Top': '在顶部添加光标',
  'Add Selection To Next Find Match': '将下一个查找匹配项添加到选择',
  'Add &&Next Occurrence': '添加下一个匹配项(&&N)',
  'Add Selection To Previous Find Match': '将选择内容添加到上一查找匹配项',
  'Add P&&revious Occurrence': '添加上一个匹配项(&&R)',
  'Move Last Selection To Next Find Match': '将上次选择移动到下一个查找匹配项',
  'Move Last Selection To Previous Find Match': '将上个选择内容移动到上一查找匹配项',
  'Select All Occurrences of Find Match': '选择所有找到的查找匹配项',
  'Select All &&Occurrences': '选择所有匹配项(&&O)',
  'Change All Occurrences': '更改所有匹配项',
  'Focus Next Cursor': '聚焦下一个光标',
  'Focuses the next cursor': '聚焦下一个光标',
  'Focus Previous Cursor': '聚焦上一个光标',
  'Focuses the previous cursor': '聚焦上一个光标',
  'Go to Next Symbol Highlight': '转到下一个突出显示的符号',
  'Go to Previous Symbol Highlight': '转到上一个突出显示的符号',
  'Trigger Symbol Highlight': '触发符号高亮',
  'Whether the current code editor is embedded inside peek': '速览中是否嵌入了当前代码编辑器',
  'Background color of the peek view title area.': '速览视图标题区域背景颜色。',
  'Color of the peek view title.': '速览视图标题颜色。',
  'Color of the peek view title info.': '速览视图标题信息颜色。',
  'Color of the peek view borders and arrow.': '速览视图边框和箭头颜色。',
  'Background color of the peek view result list.': '速览视图结果列表背景色。',
  ...
  'Foreground color of the selected entry in the peek view result list.':
    '速览视图结果列表中所选条目的前景色。',
  'Background color of the peek view editor.': '速览视图编辑器背景色。',
  'Background color of the gutter in the peek view editor.': '速览视图编辑器中装订线的背景色。',
  'Background color of sticky scroll in the peek view editor.':
    '速览视图编辑器中粘滞滚动的背景色。',
  'Match highlight color in the peek view result list.': '在速览视图结果列表中匹配突出显示颜色。',
  'Match highlight color in the peek view editor.': '在速览视图编辑器中匹配突出显示颜色。',
  'Match highlight border in the peek view editor.': '在速览视图编辑器中匹配项的突出显示边框。',
  Error: '错误',
  Warning: '警告',
  Info: '信息',
  Hint: '提示',
  '{0} at {1}. ': '{1} 中的 {0}',
  '{0} of {1} problems': '{0} 个问题(共 {1} 个)',
  '{0} of {1} problem': '{0} 个问题(共 {1} 个)',
  'Editor marker navigation widget error color.': '编辑器标记导航小组件错误颜色。',
  'Editor marker navigation widget error heading background.':
    '编辑器标记导航小组件错误标题背景色。',
  'Editor marker navigation widget warning color.': '编辑器标记导航小组件警告颜色。',
  'Editor marker navigation widget warning heading background.':
    '编辑器标记导航小组件警告标题背景色。',
  'Editor marker navigation widget info color.': '编辑器标记导航小组件信息颜色。',
  'Editor marker navigation widget info heading background.':
    '编辑器标记导航小组件信息标题背景色。',
  'Editor marker navigation widget background.': '编辑器标记导航小组件背景色。',
  'Go to Next Problem (Error, Warning, Info)': '转到下一个问题 (错误、警告、信息)',
  'Icon for goto next marker.': '“转到下一个”标记的图标。',
  'Go to Previous Problem (Error, Warning, Info)': '转到上一个问题 (错误、警告、信息)',
  'Icon for goto previous marker.': '“转到上一个”标记的图标。',
  'Go to Next Problem in Files (Error, Warning, Info)': '转到文件中的下一个问题 (错误、警告、信息)',
  'Next &&Problem': '下一个问题(&&P)',
  'Go to Previous Problem in Files (Error, Warning, Info)':
    '转到文件中的上一个问题 (错误、警告、信息)',
  'Previous &&Problem': '上一个问题(&&P)',
  ...
  Peek: '快速查看',
  Definitions: '定义',
  "No definition found for '{0}'": '未找到“{0}”的任何定义',
  'No definition found': '找不到定义',
  'Go to Definition': '转到定义',
  'Go to &&Definition': '转到定义(&&D)',
  'Open Definition to the Side': '打开侧边的定义',
  'Peek Definition': '速览定义',
  Declarations: '声明',
  "No declaration found for '{0}'": '未找到“{0}”的声明',
  'No declaration found': '未找到声明',
  'Go to Declaration': '转到声明',
  'Go to &&Declaration': '转到声明(&&D)',
  'Peek Declaration': '查看声明',
  'Type Definitions': '类型定义',
  "No type definition found for '{0}'": '未找到“{0}”的类型定义',
  'No type definition found': '未找到类型定义',
  'Go to Type Definition': '转到类型定义',
  'Go to &&Type Definition': '转到类型定义(&&T)',
  'Peek Type Definition': '快速查看类型定义',
  Implementations: '实现',
  "No implementation found for '{0}'": '未找到“{0}”的实现',
  'No implementation found': '未找到实现',
  'Go to Implementations': '转到实现',
  'Go to &&Implementations': '转到实现(&&I)',
  'Peek Implementations': '查看实现',
  "No references found for '{0}'": '未找到"{0}"的引用',
  'No references found': '未找到引用',
  'Go to References': '转到引用',
  'Go to &&References': '转到引用(&&R)',
  'Peek References': '查看引用',
  'Go to Any Symbol': '转到任何符号',
  Locations: '位置',
  "No results for '{0}'": '无“{0}”的结果',
  'Click to show {0} definitions.': '单击显示 {0} 个定义。',
  'View Problem': '查看问题',
  'No quick fixes available': '没有可用的快速修复',
  'Checking for quick fixes...': '正在检查快速修复...',
  'Show or Focus Hover': '显示或聚焦悬停',
  ...
  'The hover will not automatically take focus.': '悬停不会自动获得焦点。',
  'The hover will take focus only if it is already visible.': '仅当悬停已可见时，才会获得焦点。',
  'The hover will automatically take focus when it appears.': '悬停在出现时会自动获得焦点。',
  'Show Definition Preview Hover': '显示定义预览悬停',
  'Show the definition preview hover in the editor.': '在编辑器中显示定义预览悬停。',
  'Scroll Up Hover': '向上滚动悬停',
  'Scroll up the editor hover.': '向上滚动编辑器悬停。',
  'Scroll Down Hover': '向下滚动悬停',
  'Scroll down the editor hover.': '向下滚动编辑器悬停。',
  'Scroll Left Hover': '向左滚动悬停',
  'Scroll left the editor hover.': '向左滚动编辑器悬停。',
  'Scroll Right Hover': '向右滚动悬停',
  'Scroll right the editor hover.': '向右滚动编辑器悬停。',
  'Page Up Hover': '向上翻页悬停',
  'Page up the editor hover.': '将编辑器悬停向上翻页。',
  'Page Down Hover': '向下翻页悬停',
  'Page down the editor hover.': '将编辑器悬停向下翻页。',
  'Go To Top Hover': '转到顶部悬停',
  'Go to the top of the editor hover.': '转到编辑器悬停的顶部。',
  'Go To Bottom Hover': '转到底部悬停',
  'Go to the bottom of the editor hover.': '转到编辑器悬停的底部。',
  ...
  'The following files have been modified in an incompatible way: {0}.':
    '以下文件已以不兼容的方式修改: {0}。',
  "Could not undo '{0}' across all files. {1}": '无法在所有文件中撤消“{0}”。{1}',
  ...
  "Would you like to undo '{0}' across all files?": '是否要在所有文件中撤消“{0}”?',
  '&&Undo in {0} Files': '在 {0} 个文件中撤消(&&U)',
  'Undo this &&File': '撤消此文件(&&F)',
  "Could not undo '{0}' because there is already an undo or redo operation running.":
    '无法撤销“{0}”，因为已有一项撤消或重做操作正在运行。',
  "Would you like to undo '{0}'?": '是否要撤消“{0}”?',
  '&&Yes': '是(&&Y)',
  No: '否',
  "Could not redo '{0}' across all files. {1}": '无法在所有文件中重做“{0}”。{1}',
  ...
  'Mouse Over': '鼠标悬停',
  Always: '始终',
  'Show Editor Context Menu': '显示编辑器上下文菜单',
  'Cu&&t': '剪切(&&T)',
  Cut: '剪切',
  '&&Copy': '复制(&&C)',
  Copy: '复制',
  ...
  '&&Paste': '粘贴(&&P)',
  Paste: '粘贴',
  'Copy With Syntax Highlighting': '复制并突出显示语法',
  ...
  Nov: '11 月',
  Dec: '12月',
  "Accepting '{0}' made {1} additional edits": '选择“{0}”后进行了其他 {1} 次编辑',
  'Trigger Suggest': '触发建议',
  Insert: '插入',
  'Show Less': '显示更少',
  'Show More': '显示更多',
  'Reset Suggest Widget Size': '重置建议小组件大小',
  'Show Next Inline Suggestion': '显示下一个内联建议',
  'Show Previous Inline Suggestion': '显示上一个内联建议',
  'Trigger Inline Suggestion': '触发内联建议',
  'Accept Next Word Of Inline Suggestion': '接受内联建议的下一个字',
  'Accept Word': '接受 Word',
  'Accept Next Line Of Inline Suggestion': '接受内联建议的下一行',
  'Accept Line': '接受行',
  'Accept Inline Suggestion': '接受内联建议',
  Accept: '接受',
  ...
  'This document contains many ambiguous unicode characters': '本文档包含许多不明确的 unicode 字符',
  'This document contains many invisible unicode characters': '本文档包含许多不可见的 unicode 字符',
  'Configure Unicode Highlight Options': '配置 Unicode 突出显示选项',
  ...
  'The character {0} is invisible.': '字符 {0} 不可见。',
  'The character {0} is not a basic ASCII character.': '字符 {0} 不是基本 ASCII 字符。',
  'Adjust settings': '调整设置',
  'Disable highlighting of characters in comments': '禁用批注中字符的突出显示',
  'Disable Highlight In Comments': '禁用批注中的突出显示',
  'Disable highlighting of characters in strings': '禁用字符串中字符的突出显示',
  'Disable Highlight In Strings': '禁用字符串中的突出显示',
  'Disable highlighting of ambiguous characters': '禁止突出显示歧义字符',
  'Disable Ambiguous Highlight': '禁用不明确的突出显示',
  'Disable highlighting of invisible characters': '禁止突出显示不可见字符',
  'Disable Invisible Highlight': '禁用不可见突出显示',
  'Disable highlighting of non basic ASCII characters': '禁止突出显示非基本 ASCII 字符',
  'Disable Non ASCII Highlight': '禁用非 ASCII 突出显示',
  'Show Exclude Options': '显示排除选项',
  'Exclude {0} (invisible character) from being highlighted': '不突出显示 {0} (不可见字符)',
  'Exclude {0} from being highlighted': '在突出显示内容中排除{0}',
}
