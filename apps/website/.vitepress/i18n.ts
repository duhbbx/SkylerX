...
export const LOCALE_META: Record<string, LocaleMeta> = {
  'zh-CN': {
    description:
      '开源跨平台数据库管理工具 · 支持 20+ SQL/NoSQL 方言 · AI 加持 · Navicat / DBeaver 替代',
    ogTitle: 'SkylerX — 开源数据库管理工具',
    ogDescription: '20+ SQL/NoSQL 方言 · 国产数据库全家桶 · AI 助手 · 跨平台桌面端',
  },
  'en-US': {
    description:
      'Open-source cross-platform database tool — 20+ SQL/NoSQL dialects with AI assistance. A free Navicat / DBeaver alternative.',
    ogTitle: 'SkylerX — Open-source database tool',
    ogDescription:
      '20+ SQL/NoSQL dialects · Chinese DB family · AI assistant · Cross-platform desktop',
  },
  'es-ES': {
    description:
      'Herramienta multiplataforma de gestión de bases de datos de código abierto — 20+ dialectos SQL/NoSQL con asistencia de IA. Alternativa libre a Navicat / DBeaver.',
    ogTitle: 'SkylerX — Herramienta de BD de código abierto',
    ogDescription:
      '20+ dialectos SQL/NoSQL · Familia china de BD · Asistente IA · Escritorio multiplataforma',
  },
  'fr-FR': {
    description:
      'Outil de gestion de bases de données multiplateforme open source — 20+ dialectes SQL/NoSQL avec assistance IA. Alternative libre à Navicat / DBeaver.',
    ogTitle: 'SkylerX — Outil de BD open source',
    ogDescription:
      '20+ dialectes SQL/NoSQL · Familles BD chinoises · Assistant IA · Bureau multiplateforme',
  },
  'ja-JP': {
    description:
      'オープンソースのクロスプラットフォーム データベース管理ツール — 20+ SQL/NoSQL 方言対応、AI 支援、Navicat / DBeaver の無料代替。',
    ogTitle: 'SkylerX — オープンソース データベースツール',
    ogDescription:
      '20+ SQL/NoSQL 方言 · 中国国産 DB ファミリ · AI アシスタント · クロスプラットフォーム デスクトップ',
  },
  'ko-KR': {
    description:
      '오픈소스 크로스 플랫폼 데이터베이스 관리 도구 — 20+ SQL/NoSQL 방언, AI 어시스턴트, Navicat / DBeaver의 무료 대안.',
    ogTitle: 'SkylerX — 오픈소스 데이터베이스 도구',
    ogDescription:
      '20+ SQL/NoSQL 방언 · 중국 국산 DB 패밀리 · AI 어시스턴트 · 크로스 플랫폼 데스크톱',
  },
  'pt-BR': {
    description:
      'Ferramenta multiplataforma de gerenciamento de banco de dados de código aberto — 20+ dialetos SQL/NoSQL com assistência de IA. Alternativa livre ao Navicat / DBeaver.',
    ogTitle: 'SkylerX — Ferramenta de BD open source',
    ogDescription:
      '20+ dialetos SQL/NoSQL · Família de BDs chinesas · Assistente IA · Desktop multiplataforma',
  },
}
...
const EN_FEATURES: ComponentLabels['features'] = [
  {
    icon: '🧠',
    title: 'AI Assistant',
    desc: 'Pick from Anthropic / OpenAI / DeepSeek / Codex / Grok, with 7 built-in toolboxes and inline completion',
  },
  {
    icon: '🔌',
    title: '20+ Dialects',
    desc: 'Mainstream SQL + Chinese DBs (DM / Kingbase / openGauss / OceanBase / TiDB) + NoSQL (Mongo / Redis / ES)',
  },
  {
    icon: '✏️',
    title: 'Monaco Editor',
    desc: 'SQL highlighting, autocompletion, formatting, parameterized queries, snippet library — run with ⌘+Enter',
  },
  {
    icon: '📊',
    title: 'Rich Result Grid',
    desc: 'Virtual scroll + inline edit + JSON/BLOB detection + numeric sparklines + conditional coloring',
  },
  {
    icon: '🛡',
    title: 'Production Safety',
    desc: 'Prod-flagged connections + dangerous-SQL confirmation + SQL linter + data masking & contracts',
  },
  {
    icon: '🔍',
    title: 'EXPLAIN Visualizer',
    desc: 'Estimated vs actual rows, slow operators highlighted, optional real ANALYZE run',
  },
  {
    icon: '🧬',
    title: 'Schema Diff & Drift',
    desc: 'Compare two connections → auto-generate alignment SQL; schema snapshots + evolution history',
  },
  {
    icon: '🛠',
    title: 'DBA Toolbox',
    desc: 'Server activity / KILL / slow-query log parsing / replication lag monitoring / index suggestions',
  },
  {
    icon: '🇨🇳',
    title: 'Chinese Stack Ready',
    desc: 'DM / Kingbase / openGauss / OceanBase / TiDB + SM2/SM3/SM4 crypto + GB-compliance panels',
  },
]
...
const ES_FEATURES: ComponentLabels['features'] = [
  {
    icon: '🧠',
    title: 'Asistente IA',
    desc: 'Elige entre Anthropic / OpenAI / DeepSeek / Codex / Grok, con 7 toolboxes integrados y autocompletado en línea',
  },
  {
    icon: '🔌',
    title: '20+ dialectos',
    desc: 'SQL principales + bases chinas (DM / Kingbase / openGauss / OceanBase / TiDB) + NoSQL (Mongo / Redis / ES)',
  },
  {
    icon: '✏️',
    title: 'Editor Monaco',
    desc: 'Resaltado SQL, autocompletado, formato, consultas parametrizadas, biblioteca de snippets; ⌘+Enter para ejecutar',
  },
  {
    icon: '📊',
    title: 'Resultados visuales',
    desc: 'Scroll virtual + edición en línea + detección JSON/BLOB + sparklines numéricos + coloreado condicional',
  },
  {
    icon: '🛡',
    title: 'Protección de producción',
    desc: 'Marcado prod + confirmación de SQL peligroso + linter SQL + enmascaramiento y contratos de datos',
  },
  {
    icon: '🔍',
    title: 'EXPLAIN visual',
    desc: 'Filas estimadas vs reales, operadores lentos resaltados, ANALYZE real opcional',
  },
  {
    icon: '🧬',
    title: 'Diff y deriva de esquema',
    desc: 'Compara dos conexiones → SQL de alineación auto-generado; snapshots + historial de evolución',
  },
  {
    icon: '🛠',
    title: 'Caja de herramientas DBA',
    desc: 'Actividad del servidor / KILL / parser de slow log / monitor de replicación / sugerencias de índices',
  },
  {
    icon: '🇨🇳',
    title: 'Listo para stack chino',
    desc: 'DM / Kingbase / openGauss / OceanBase / TiDB + criptografía SM2/SM3/SM4 + paneles de cumplimiento',
  },
]
...
const FR_FEATURES: ComponentLabels['features'] = [
  {
    icon: '🧠',
    title: 'Assistant IA',
    desc: 'Anthropic / OpenAI / DeepSeek / Codex / Grok au choix, avec 7 toolboxes intégrées et complétion en ligne',
  },
  {
    icon: '🔌',
    title: '20+ dialectes',
    desc: 'SQL grand public + BDD chinoises (DM / Kingbase / openGauss / OceanBase / TiDB) + NoSQL (Mongo / Redis / ES)',
  },
  {
    icon: '✏️',
    title: 'Éditeur Monaco',
    desc: 'Coloration SQL, complétion, formatage, requêtes paramétrées, bibliothèque de snippets ; ⌘+Entrée pour exécuter',
  },
  {
    icon: '📊',
    title: 'Grille de résultats riche',
    desc: 'Scroll virtuel + édition en ligne + détection JSON/BLOB + sparklines numériques + coloration conditionnelle',
  },
  {
    icon: '🛡',
    title: 'Sécurité prod',
    desc: 'Marquage prod + confirmation des SQL dangereux + linter SQL + masquage et contrats de données',
  },
  {
    icon: '🔍',
    title: 'Visualiseur EXPLAIN',
    desc: 'Lignes estimées vs réelles, opérateurs lents surlignés, ANALYZE réel optionnel',
  },
  {
    icon: '🧬',
    title: 'Diff et dérive de schéma',
    desc: "Compare deux connexions → SQL d'alignement auto-généré ; snapshots + historique d'évolution",
  },
  {
    icon: '🛠',
    title: 'Boîte à outils DBA',
    desc: "Activité serveur / KILL / parser de slow log / monitoring de réplication / recommandations d'index",
  },
  {
    icon: '🇨🇳',
    title: 'Stack chinois prêt',
    desc: 'DM / Kingbase / openGauss / OceanBase / TiDB + crypto SM2/SM3/SM4 + panneaux de conformité GB',
  },
]
...
const JA_FEATURES: ComponentLabels['features'] = [
  {
    icon: '🧠',
    title: 'AI アシスタント',
    desc: 'Anthropic / OpenAI / DeepSeek / Codex / Grok から選択、7 つの専門 Toolbox とインライン補完を内蔵',
  },
  {
    icon: '🔌',
    title: '20+ 方言',
    desc: '主要 SQL + 中国国産 DB(DM / Kingbase / openGauss / OceanBase / TiDB)+ NoSQL(Mongo / Redis / ES)',
  },
  {
    icon: '✏️',
    title: 'Monaco エディタ',
    desc: 'SQL ハイライト + 補完 + フォーマット + パラメータ化クエリ + スニペット;⌘+Enter で実行',
  },
  {
    icon: '📊',
    title: 'リッチな結果グリッド',
    desc: '仮想スクロール + インライン編集 + JSON/BLOB 認識 + 数値列スパークライン + 条件付き配色',
  },
  {
    icon: '🛡',
    title: 'プロダクション保護',
    desc: 'prod フラグ + 危険 SQL の二段確認 + SQL Linter + データマスキング / コントラクト',
  },
  {
    icon: '🔍',
    title: 'EXPLAIN ビジュアライザ',
    desc: '予測 vs 実際の行数、遅い演算子をハイライト、任意で ANALYZE を実行',
  },
  {
    icon: '🧬',
    title: 'スキーマ Diff / ドリフト',
    desc: '2 接続を比較 → 整合 SQL を自動生成、スキーマスナップショット + 履歴',
  },
  {
    icon: '🛠',
    title: 'DBA ツールボックス',
    desc: 'サーバ活動 / KILL / スローログ解析 / レプリ遅延監視 / インデックス推奨',
  },
  {
    icon: '🇨🇳',
    title: '中国国産 DB 対応',
    desc: 'DM / Kingbase / openGauss / OceanBase / TiDB + SM2/SM3/SM4 国密 + GB 準拠パネル',
  },
]
...
const KO_FEATURES: ComponentLabels['features'] = [
  {
    icon: '🧠',
    title: 'AI 어시스턴트',
    desc: 'Anthropic / OpenAI / DeepSeek / Codex / Grok 선택, 7 개 전문 Toolbox + 인라인 자동완성 내장',
  },
  {
    icon: '🔌',
    title: '20+ 방언',
    desc: '주요 SQL + 중국 국산 DB(DM / Kingbase / openGauss / OceanBase / TiDB)+ NoSQL(Mongo / Redis / ES)',
  },
  {
    icon: '✏️',
    title: 'Monaco 에디터',
    desc: 'SQL 하이라이트, 자동완성, 포맷, 파라미터 쿼리, 스니펫; ⌘+Enter 로 실행',
  },
  {
    icon: '📊',
    title: '풍부한 결과 그리드',
    desc: '가상 스크롤 + 인라인 편집 + JSON/BLOB 인식 + 숫자 컬럼 스파크라인 + 조건부 색상',
  },
  {
    icon: '🛡',
    title: '프로덕션 보호',
    desc: 'prod 표시 + 위험 SQL 재확인 + SQL Linter + 데이터 마스킹 / 계약',
  },
  {
    icon: '🔍',
    title: 'EXPLAIN 시각화',
    desc: '예상 vs 실제 행 수, 느린 연산자 하이라이트, 선택적 ANALYZE 실행',
  },
  {
    icon: '🧬',
    title: '스키마 Diff / 드리프트',
    desc: '두 연결 비교 → 정렬 SQL 자동 생성; 스키마 스냅샷 + 진화 이력',
  },
  {
    icon: '🛠',
    title: 'DBA 툴박스',
    desc: '서버 활동 / KILL / 슬로우 쿼리 로그 파싱 / 복제 지연 모니터링 / 인덱스 추천',
  },
  {
    icon: '🇨🇳',
    title: '중국 국산 DB 지원',
    desc: 'DM / Kingbase / openGauss / OceanBase / TiDB + SM2/SM3/SM4 + 등급 보호 컴플라이언스 패널',
  },
]
...
const PT_FEATURES: ComponentLabels['features'] = [
  {
    icon: '🧠',
    title: 'Assistente IA',
    desc: 'Anthropic / OpenAI / DeepSeek / Codex / Grok à escolha, com 7 toolboxes integradas e autocompletar inline',
  },
  {
    icon: '🔌',
    title: '20+ dialetos',
    desc: 'SQL convencionais + bancos chineses (DM / Kingbase / openGauss / OceanBase / TiDB) + NoSQL (Mongo / Redis / ES)',
  },
  {
    icon: '✏️',
    title: 'Editor Monaco',
    desc: 'Realce SQL, autocompletar, formatação, queries parametrizadas, biblioteca de snippets; ⌘+Enter para executar',
  },
  {
    icon: '📊',
    title: 'Grade de resultados rica',
    desc: 'Scroll virtual + edição inline + detecção JSON/BLOB + sparklines numéricos + coloração condicional',
  },
  {
    icon: '🛡',
    title: 'Proteção de produção',
    desc: 'Marcação prod + confirmação de SQL perigoso + linter SQL + mascaramento e contratos de dados',
  },
  {
    icon: '🔍',
    title: 'Visualizador EXPLAIN',
    desc: 'Linhas estimadas vs reais, operadores lentos destacados, ANALYZE real opcional',
  },
  {
    icon: '🧬',
    title: 'Diff e drift de esquema',
    desc: 'Compare duas conexões → SQL de alinhamento auto-gerado; snapshots de esquema + histórico de evolução',
  },
  {
    icon: '🛠',
    title: 'Caixa de ferramentas DBA',
    desc: 'Atividade do servidor / KILL / parser de slow log / monitoramento de replicação / sugestão de índices',
  },
  {
    icon: '🇨🇳',
    title: 'Pronto para stack chinês',
    desc: 'DM / Kingbase / openGauss / OceanBase / TiDB + criptografia SM2/SM3/SM4 + painéis de conformidade GB',
  },
]
...
export const COMPONENT_LABELS: Record<string, ComponentLabels> = {
  'zh-CN': {
    ...
    matrix: {
      ...
      tipOss:
        '💡 当前是国内镜像(阿里云 OSS · 华东 2 上海)。如果国内访问也慢,切到 GitHub 试试;海外用户建议直接选 GitHub。',
      tipGithub:
        '💡 当前是 GitHub Releases。中国大陆用户访问慢时,点上方 “🇨🇳 国内镜像” 切换到阿里云 OSS;或用 https://github.akams.cn/ 等加速镜像替换 URL 前缀。',
    },
    lightbox: { close: '关闭' },
  },
  ...
  'en-US': {
    ...
    download: {
      ...
      githubSrc: '· 🌐 GitHub',
      cnTip:
        'Mainland China defaults to the Aliyun OSS mirror; you can switch to GitHub on the download page',
      intlTip:
        'Defaults to GitHub Releases overseas; you can switch to the OSS mirror on the download page',
    },
    matrix: {
      loading: 'Loading…',
      ...
      tipOss:
        '💡 You are on the China mirror (Aliyun OSS · East China 2, Shanghai). If even this is slow, try GitHub; users outside mainland China should pick GitHub directly.',
      tipGithub:
        '💡 You are on GitHub Releases. Mainland China users who experience slow downloads can click "🇨🇳 China mirror" above to switch to Aliyun OSS, or replace the URL prefix with an accelerator such as https://github.akams.cn/.',
    },
  ...
  'es-ES': {
    ...
    download: {
      ...
      githubSrc: '· 🌐 GitHub',
      cnTip:
        'China continental usa por defecto el espejo Aliyun OSS; puedes cambiar a GitHub en la página de descargas',
      intlTip:
        'Por defecto usa GitHub Releases; puedes cambiar al espejo OSS en la página de descargas',
    },
    matrix: {
      loading: 'Cargando…',
      ...
      tipOss:
        '💡 Estás en el espejo de China (Aliyun OSS · Este de China 2, Shanghái). Si va lento, prueba GitHub; los usuarios fuera de China continental deberían elegir GitHub directamente.',
      tipGithub:
        '💡 Estás en GitHub Releases. Si las descargas son lentas desde China continental, pulsa "🇨🇳 Espejo China" arriba para cambiar a Aliyun OSS, o usa un acelerador como https://github.akams.cn/.',
    },
  ...
  'fr-FR': {
    ...
    download: {
      ...
      githubSrc: '· 🌐 GitHub',
      cnTip:
        'La Chine continentale utilise par défaut le miroir Aliyun OSS ; vous pouvez basculer sur GitHub depuis la page de téléchargement',
      intlTip:
        'Utilise par défaut GitHub Releases ; vous pouvez basculer sur le miroir OSS depuis la page de téléchargement',
    },
    matrix: {
      loading: 'Chargement…',
      ...
      tipOss:
        "💡 Vous êtes sur le miroir Chine (Aliyun OSS · Chine Est 2, Shanghai). Si c'est lent, essayez GitHub ; les utilisateurs hors Chine continentale devraient choisir GitHub directement.",
      tipGithub:
        '💡 Vous êtes sur GitHub Releases. Si les téléchargements sont lents depuis la Chine continentale, cliquez sur « 🇨🇳 Miroir Chine » ci-dessus pour basculer sur Aliyun OSS, ou utilisez un accélérateur comme https://github.akams.cn/.',
    },
  ...
  'ja-JP': {
    ...
    download: {
      ...
      githubSrc: '· 🌐 GitHub',
      cnTip:
        '中国本土ではデフォルトで Aliyun OSS ミラーを使用、ダウンロードページで GitHub に切替可',
    ...
    matrix: {
      ...
      tipOss:
        '💡 現在は中国ミラー(Aliyun OSS · 華東 2 上海)です。遅い場合は GitHub を試してください。海外ユーザーは GitHub を直接選ぶことをお勧めします。',
      tipGithub:
        '💡 現在は GitHub Releases です。中国本土からのアクセスが遅い場合は上部の「🇨🇳 中国ミラー」をクリックして Aliyun OSS に切替えるか、https://github.akams.cn/ などの高速化ミラーで URL を置換してください。',
    },
    lightbox: { close: '閉じる' },
  },
  ...
  'ko-KR': {
    ...
    matrix: {
      ...
      tipOss:
        '💡 현재 중국 미러(Aliyun OSS · 화동 2 상하이)입니다. 느리면 GitHub 으로 전환해보세요. 해외 사용자는 GitHub 을 직접 선택하는 것을 권장합니다.',
      tipGithub:
        '💡 현재 GitHub Releases 입니다. 중국 본토에서 느릴 경우 위의 "🇨🇳 중국 미러" 를 눌러 Aliyun OSS 로 전환하거나, https://github.akams.cn/ 같은 가속 미러로 URL 을 교체하세요.',
    },
    lightbox: { close: '닫기' },
  },
  ...
  'pt-BR': {
    ...
    download: {
      ...
      githubSrc: '· 🌐 GitHub',
      cnTip:
        'China continental usa por padrão o espelho Aliyun OSS; você pode trocar para o GitHub na página de download',
      intlTip:
        'Por padrão usa GitHub Releases; você pode trocar para o espelho OSS na página de download',
    },
    matrix: {
      loading: 'Carregando…',
      ...
      tipOss:
        '💡 Você está no espelho China (Aliyun OSS · Leste China 2, Xangai). Se estiver lento, tente o GitHub; usuários fora da China continental deveriam escolher GitHub direto.',
      tipGithub:
        '💡 Você está no GitHub Releases. Se downloads forem lentos da China continental, clique em "🇨🇳 Espelho China" acima para trocar para Aliyun OSS, ou use um acelerador como https://github.akams.cn/.',
    },
...
export function makeThemeConfig(L: LocaleLabels, prefix: string): DefaultTheme.Config {
  return {
    ...
    nav: [
      ...
      { text: L.roadmap, link: `${prefix}/roadmap` },
      {
        text: L.links,
        items: [
